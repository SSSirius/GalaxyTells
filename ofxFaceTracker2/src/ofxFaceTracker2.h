...
public:
    ...
    void drawMesh(int x, int y, int w, int h) const;
    vector<float> eyedist();
    vector<float> eyesize();
    vector<float> mouthdist();
    vector<float> nosedist();
    vector<float> facedist();
    vector<float> mouthvertidist();
